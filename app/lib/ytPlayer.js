...
function getVideo(id) {
    ...
    if(OS_IOS) {
        client.setRequestHeader('Referer', 'https://www.youtube.com/watch?v=' + id);
    ...
    client.open('GET', 'https://m.youtube.com/watch?ajax=1&layout=mobile&tsp=1&utcoffset=330&v=' + id);
    if(OS_ANDROID) {
        client.setRequestHeader('Referer', 'https://www.youtube.com/watch?v=' + id);
